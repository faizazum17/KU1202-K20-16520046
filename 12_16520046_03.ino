...
const int ledR_Pin = 2;			// pin Arduino yang terhubung ke Servo ke LED(Red)
const int ledB_Pin = 3;			// pin Arduino yang terhubung ke Servo ke LED(Blue)
const int ledG_Pin = 4;			// pin Arduino yang terhubung ke Servo ke LED(Green)
const int buzzPin = 8;			// pin Arduino yang terhubung ke Servo ke Buzzer
...
void loop()
{
  ...
  for (pos = 90; pos >= 0; pos -= 1) {
    servo_0.write(pos);			// minta servo agar menuju posis di variabel 'pos'
    delay(15);					// tunggu 15 ms untuk servo mencapai posisi
  }
